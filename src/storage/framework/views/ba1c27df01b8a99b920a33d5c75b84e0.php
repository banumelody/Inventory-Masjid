<?php $__env->startSection('title', 'Daftar Feedback - Inventory Masjid'); ?>
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($feedback->created_at->format('d/m/Y H:i')); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($feedback->user?->name ?? 'Guest'); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e(ucfirst($feedback->module)); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($feedback->type_label); ?></td>
                <td class="px-6 py-4 text-sm text-gray-900"><?php echo e(Str::limit($feedback->message, 50)); ?></td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="px-2 py-1 text-xs font-semibold rounded-full bg-<?php echo e($feedback->status_color); ?>-100 text-<?php echo e($feedback->status_color); ?>-800">
                        <?php echo e($feedback->status_label); ?>

                    </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button onclick="openModal(<?php echo e($feedback->id); ?>, '<?php echo e($feedback->status); ?>', '<?php echo e(addslashes($feedback->admin_notes)); ?>')" class="text-blue-600 hover:text-blue-900">Update</button>
                    <form action="<?php echo e(route('feedbacks.destroy', $feedback)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin hapus?')">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/feedbacks/index.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Edit Barang - Inventory Masjid'); ?>
        ...
        <form action="<?php echo e(route('items.update', $item)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select name="location_id" id="location_id" required
                        ...
                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($location->id); ?>" <?php echo e(old('location_id', $item->location_id) == $location->id ? 'selected' : ''); ?>>
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select name="unit" id="unit" required
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-green-500 focus:border-green-500">
                        <option value="pcs" <?php echo e(old('unit', $item->unit) == 'pcs' ? 'selected' : ''); ?>>pcs</option>
                        <option value="unit" <?php echo e(old('unit', $item->unit) == 'unit' ? 'selected' : ''); ?>>unit</option>
                        <option value="set" <?php echo e(old('unit', $item->unit) == 'set' ? 'selected' : ''); ?>>set</option>
                        <option value="buah" <?php echo e(old('unit', $item->unit) == 'buah' ? 'selected' : ''); ?>>buah</option>
                        <option value="lembar" <?php echo e(old('unit', $item->unit) == 'lembar' ? 'selected' : ''); ?>>lembar</option>
                        <option value="roll" <?php echo e(old('unit', $item->unit) == 'roll' ? 'selected' : ''); ?>>roll</option>
                    </select>
                </div>
                <div>
            ...
            <div class="mb-4">
                ...
                <div class="mb-3 flex items-center space-x-4">
                    <img src="<?php echo e($item->photo_url); ?>" alt="<?php echo e($item->name); ?>" class="w-24 h-24 object-cover rounded">
            ...
            <div class="mb-6">
                ...
                <textarea name="note" id="note" rows="3"
                    class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-green-500 focus:border-green-500"><?php echo e(old('note', $item->note)); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/items/edit.blade.php ENDPATH**/ ?>
...
@section('title', 'Edit Kategori - Inventory Masjid')

@section('content')
<div class="max-w-xl mx-auto">
    <x-breadcrumb :items="[['label' => 'Kategori', 'url' => route('categories.index')], ['label' => $category->name, 'url' => route('categories.index')], ['label' => 'Edit']]" />

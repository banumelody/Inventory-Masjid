...
@section('title', 'Edit Lokasi - Inventory Masjid')

@section('content')
<div class="max-w-xl mx-auto">
    <x-breadcrumb :items="[['label' => 'Lokasi', 'url' => route('locations.index')], ['label' => $location->name, 'url' => route('locations.index')], ['label' => 'Edit']]" />
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('locations.update', $location) }}" method="POST">
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('locations.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-3 rounded-lg font-semibold">
                    Batal
                </a>

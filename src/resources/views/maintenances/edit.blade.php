...
<div class="max-w-2xl mx-auto">
    <x-breadcrumb :items="[['label' => 'Maintenance', 'url' => route('maintenances.index')], ['label' => $maintenance->item->name ?? 'Detail', 'url' => route('maintenances.show', $maintenance)], ['label' => 'Edit']]" />
    <div class="mb-6">
    </div>
